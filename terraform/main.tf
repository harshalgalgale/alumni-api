...
output result {
  value = <<EOF
    ...
    The ${var.service} is now running at ${module.alumni.service_url}
    ...
    You can then log into the Django admin: ${module.alumni.service_url}/admin
